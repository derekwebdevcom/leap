...
class wpsm_team_b {
	...
	public function wpsm_team_b_meta_boxes_group(){
		...
		add_meta_box ('team_b_more_free_plugins', __('More Free Plugins From Wpshopmart', wpshopmart_team_b_text_domain), array(&$this, 'wpsm_team_pic_more_free_plugins'), 'team_builder', 'normal', 'low');		
	...
	public function wpsm_team_pic_more_free_plugins(){
